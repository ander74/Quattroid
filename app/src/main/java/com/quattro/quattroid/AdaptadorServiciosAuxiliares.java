...
public class AdaptadorServiciosAuxiliares extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        servicio.setText(cursor.getString(cursor.getColumnIndex("ServicioAuxiliar")));
        turno.setText(String.valueOf(cursor.getInt(cursor.getColumnIndex("TurnoAuxiliar"))));
        linea.setText(cursor.getString(cursor.getColumnIndex("LineaAuxiliar")));

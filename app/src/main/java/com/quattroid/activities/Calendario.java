...
//        listadoHoras = findViewById(R.id.ly_horas);
    ...
    private void escribeTitulo() {
        getActionBar().setTitle(HoraHelper.MESES_MAY[mesActual]);
    ...
    private void escribeHoras() {
        ...
        acumuladas.setText(HoraHelper.textoDecimal(acumHastaMes));
        ...
        acumuladasMes.setText(HoraHelper.textoDecimal(acumMesActual));
        // Escribimos las nocturnas
        nocturnas.setText(HoraHelper.textoDecimal(noctMes));
        // Escribimos las horas del toma y deje.
        tomaDeje.setText(HoraHelper.textoDecimal(tomaDejeMes));
        // Escribimos los euros por servicio.
        euros.setText(HoraHelper.textoDecimal(eurosMes));
        // Escribimos las trabajadas reales.
        trabajadasReales.setText(HoraHelper.textoDecimal(trabMes));
        // Escribimos las trabajadas por convenio
        trabajadasConvenio.setText(HoraHelper.textoDecimal(trabConvMes));
    }
    ...
    public void crearPDF() {
        ...
        String Ruta = destino + "/" + añoActual + "-" + String.format("%02d", mesActual) + " - Calendario " + HoraHelper.MESES_MIN[mesActual] + ".pdf";
        Document doc = null;
        try {
        ...
        Toast.makeText(this, "Se ha creado " + añoActual + "-" + HoraHelper.MESES_MIN[mesActual] + ".pdf" + ".", Toast.LENGTH_SHORT).show();
    }
    ...
    public Table crearTablaCalendario(boolean horizontal) throws IOException {
        ...
        celda.add(new Paragraph(HoraHelper.MESES_MIN[mesActual] + " - " + añoActual)).addStyle(estiloTitulo).setTextAlignment(TextAlignment.RIGHT);
        tabla.addHeaderCell(celda);

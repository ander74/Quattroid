...
public class DiaCalendario extends Activity implements View.OnFocusChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CalculosHelper.setAlturaLista(listaServiciosDia);
...
//    }
            ...
            switch (v.getId()) {
                ...
                case R.id.et_tomaDeje:
                    ...
                    if (!texto.getText().toString().equals(cadenaTomaDeje)) {
                        hayCambios = true;
                        String td = HoraHelper.horaToString(inputTomaDeje.getText().toString().trim());
                        if (td.equals("")) {
                            datosDia.setTomaDeje("");
                            datosDia.setTomaDejeDecimal(0d);
                        } else {
                            datosDia.setTomaDeje(td);
                            datosDia.setTomaDejeDecimal(HoraHelper.horaToDecimal(td));
                        }
                        cadenaTomaDeje = "";
                        rellenarDia();
                    }
                ...
                case R.id.et_euros:
                    ...
                    if (!texto.getText().toString().equals(cadenaEuros)) {
                        hayCambios = true;
                        String e = HoraHelper.validaHoraDecimal(inputEuros.getText().toString().trim());
                        if (e.equals("")) {
                ...
                case R.id.et_huelga:
                    ...
                    if (!texto.getText().toString().equals(cadenaHorasHuelga)) {
                        hayCambios = true;
                        String e = HoraHelper.validaHoraDecimal(inputHuelga.getText().toString().trim());
                        if (e.equals("")) {
    ...
    public void onClick(View v) {
        ...
        dialogo.setPositiveButton("Aceptar", (dialog, which) -> {
            String td = HoraHelper.validaHoraDecimal(input.getText().toString());
            if (!td.equals("")) {
        ...
        switch (v.getId()) {
            case R.id.tv_trabajadas:
                vibrador.vibrate(50);
                input.setText(HoraHelper.textoDecimal(datosDia.getTrabajadas()));
                input.selectAll();
            ...
            case R.id.tv_acumuladas:
                vibrador.vibrate(50);
                input.setText(HoraHelper.textoDecimal(datosDia.getAcumuladas()));
                input.selectAll();
                dialogo.setView(input);
            ...
            case R.id.tv_nocturnas:
                vibrador.vibrate(50);
                input.setText(HoraHelper.textoDecimal(datosDia.getNocturnas()));
                input.selectAll();
                dialogo.setView(input);
    ...
    */
    ...
    private void escribirTitulo() {
        ...
        s += " - " + HoraHelper.DIAS_SEMANA[diaSemanaActual];
        String ss = HoraHelper.MESES_MIN[mesActual] + " - " + añoActual;
    ...
    private void escribirHoras() {
        String txt;
        txt = "Tra. : ";
        txt += HoraHelper.textoDecimal(datosDia.getTrabajadas());
        textoTrabajadas.setText(txt);
        txt = "Noc. : ";
        txt += HoraHelper.textoDecimal(datosDia.getNocturnas());
        ...
        txt += HoraHelper.textoDecimal(datosDia.getAcumuladas());
    ...
    public void rellenarDia() {
        ...
        if (datosDia.getCodigoIncidencia() == 15) {
            if (datosDia.getHorasHuelga() == 0) {
                ...
                inputHuelga.setText(HoraHelper.textoDecimal(datosDia.getHorasHuelga()));
            }
        ...
        if (datosDia.getEuros() == 0) {
            ...
            inputEuros.setText(HoraHelper.textoDecimal(datosDia.getEuros()));
        }
    ...
    public void validarCampos() {
        ...
        datosDia.setLinea(l);
        // SERVICIO
        String s = HoraHelper.validarServicio(inputServicio.getText().toString().trim());
        if (s.equals("")) {
            datosDia.setServicio("");
        }
        ...
        // INICIO
        String i = HoraHelper.horaToString(inputInicio.getText().toString().trim());
        if (i.equals("")) {
            datosDia.setInicio("");
        }
        datosDia.setInicio(i);
        // FINAL
        String f = HoraHelper.horaToString(inputFinal.getText().toString().trim());
        if (f.equals("")) {
            datosDia.setFinal("");
        }
        datosDia.setFinal(f);
        ...
        // HORAS HUELGA
        String hh = HoraHelper.validaHoraDecimal(inputHuelga.getText().toString().trim());
        if (hh.equals("")) {
            datosDia.setHorasHuelga(0d);
        } else {
    ...
    public void regularAño() {
        ...
        if (datosDia.getDia() == 29 && datosDia.getMes() == 2 && datos.opciones.isRegularBisiestos()) {
            ...
            double diff = HoraHelper.redondeaDecimal4(jAnual - jBisiestos);

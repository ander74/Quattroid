...
public class AdaptadorBusquedas extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String fechaActual = HoraHelper.MESES_MIN[cursor.getInt(cursor.getColumnIndexOrThrow("Mes"))] + " - " +
        ...
        switch (estadoFila[pos]) {
            ...
            case DESCONOCIDO:
                if (pos == 0) {
                    ...
                    fechaAnterior = HoraHelper.MESES_MIN[cursor.getInt(cursor.getColumnIndexOrThrow("Mes"))] + " - " +
                            cursor.getInt(cursor.getColumnIndexOrThrow("Año"));
        ...
        Dia.setText(s);
        DiaSemana.setText(HoraHelper.DIAS_SEMANA_ABREV[Dsemana]);
        ...
        if (!s.equals("")) {
            if (tipo > 0 && tipo < 4 && cursor.getInt(cursor.getColumnIndexOrThrow("Turno")) != 0) {
                Nocturnas.setText(HoraHelper.textoDecimal(cursor.getDouble(cursor.getColumnIndexOrThrow("Nocturnas"))));
                ...
                Acumuladas.setText(HoraHelper.textoDecimal(acum));

...
import com.quattroid.ActivityHelpers.AjustesTextWhatchers;
...
public class Ajustes extends Activity implements View.OnFocusChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    AjustesTextWhatchers whatchers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whatchers = new AjustesTextWhatchers(datos);
        ...
        binding.etAcumuladasAnteriores.setText(Hora.textoDecimal(datos.opciones.getAcumuladasAnteriores()));
        ...
        binding.etJornadaMedia.setText(Hora.textoDecimal(datos.opciones.getJornadaMedia()));
        binding.etJornadaMinima.setText(Hora.textoDecimal(datos.opciones.getJornadaMinima()));
        binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getLimiteEntreServicios()));
        ...
        binding.etInicioNocturnas.setText(Hora.horaToString(datos.opciones.getInicioNocturnas()));
        binding.etFinalNocturnas.setText(Hora.horaToString(datos.opciones.getFinalNocturnas()));
        binding.etDesayuno.setText(Hora.horaToString(datos.opciones.getLimiteDesayuno()));
        binding.etComida1.setText(Hora.horaToString(datos.opciones.getLimiteComida1()));
        binding.etComida2.setText(Hora.horaToString(datos.opciones.getLimiteComida2()));
        binding.etCena.setText(Hora.horaToString(datos.opciones.getLimiteCena()));
        ...
        if (!hasFocus) {
            switch (v.getId()) {
                ...
                case R.id.et_inicioNocturnas:
                    binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getInicioNocturnas()));
                    break;
                case R.id.et_finalNocturnas:
                    binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getFinalNocturnas()));
                    break;
                case R.id.et_desayuno:
                    binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getLimiteDesayuno()));
                    break;
                case R.id.et_comida1:
                    binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getLimiteComida1()));
                    break;
                case R.id.et_comida2:
                    binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getLimiteComida2()));
                    break;
                case R.id.et_cena:
                    binding.etLimiteServicios.setText(Hora.horaToString(datos.opciones.getLimiteCena()));
                    break;
